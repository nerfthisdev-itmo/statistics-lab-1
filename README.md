...
Репозиторий с кодом для первой лабораторной по матстату
...
![alt text](https://github.com/nerfthisdev-itmo/statistics-lab-1/blob/development/output/task1/eCDF.png?raw=true)
![alt text](https://github.com/nerfthisdev-itmo/statistics-lab-1/blob/development/output/task1/polygon.png?raw=true)
![alt text](https://github.com/nerfthisdev-itmo/statistics-lab-1/blob/development/output/task1/cumulative.png)

## Выборка B

![alt text](https://github.com/nerfthisdev-itmo/statistics-lab-1/blob/development/output/task2/eCDF.png?raw=true)
![alt text](https://github.com/nerfthisdev-itmo/statistics-lab-1/blob/development/output/task2/cumulative.png?raw=true)
![alt text](https://github.com/nerfthisdev-itmo/statistics-lab-1/blob/development/output/task2/polygon.png?raw=true)
![alt text](https://github.com/nerfthisdev-itmo/statistics-lab-1/blob/development/output/task2/ogive.png?raw=true)
